...
class MissionCreate(Resource):
    def post(self):
        try:
            ...
            Mission.save_products(self, datas['name'], datas['release_date'], datas['endpoint'], datas['mission_state'], datas['crew'], datas['playload', datas['duration'], datas['cast'], datas['status']])
...
class MissionUpdate(Resource):
    def put(self):
        try:
            ...
            Mission.update_products(self, datas['id'], 
            datas['name'],
            datas['release_date'],
            datas['endpoint'],
            datas['mission_state'],
